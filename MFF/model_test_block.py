...
def model_test_visualization(model_path, dataset_test):
...
parser.add_argument("--AE_num_blocks", type=int, default=5, help="")
...
model_test_visualization(model_path=opt.model_path, dataset_test=dataset_test)
